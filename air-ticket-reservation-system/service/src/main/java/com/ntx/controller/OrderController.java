...
import com.ntx.config.RabbitMQConfig;
import com.ntx.dto.OrderDTO;
import com.ntx.entity.*;
import com.ntx.service.*;
...
import static com.ntx.constants.RedisConstants.FLIGHT_MSG;
import static com.ntx.constants.RedisConstants.ORDER_MSG;
import static com.ntx.constants.SystemConstants.*;
...
public class OrderController {
    ...
    public JsonResponse purchase(@RequestBody OrderDTO orders) {
            ...
            for(int i = 0; i < orders.getOrders().size(); i++){
                ...
                //将orderSuccess转化成json发给消息队列处理,不转成json，rabbitmq会将其转成object对象，序列化发给队列
